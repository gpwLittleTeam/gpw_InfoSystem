...
<SCRIPT type="text/javascript">
	...
	function check_submit() {
		...
		//		} else {
		//alert("正在提交");
		targetForm.action = "infoEntry_submit";
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
																		...
																		<tr>
																				...
																				<td class=input-td>
																						<input id="expert.Expert_Field2" name="expert.Expert_Field2" type=<%=type[1]%>
																								value="" class=input-text style="width:<%=width[1] %>px"
										...
										<td height="25" bgcolor="#FFFFFF" class="STYLE2">
											...
											%>
																		...
																		<%-- <tr>
										<td class="firTd"><span class="STYLE7">${fieldName[7] }</span></td>
										<td class="input-td"><input name="expert.Expert_Field8"
											type="text" class=input-text /></td>
										<td class="thirdTd">${remariksName[7] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[8] }</span></td>
										<td class=input-td><input name="expert.Expert_Field9"
											type="date" style="height:20px" /></td>
										<td class="thirdTd">${remariksName[8] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[9] }</span></td>
										<td class=input-td><input name="expert.Expert_Field10"
											type="text" class=input-text /></td>
										<td class="thirdTd">${remariksName[9] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[10] }</span></td>
										<td class=input-td><input name="expert.Expert_Field11"
											type="date" style="height:20px" /></td>
										<td class="thirdTd">${remariksName[10] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[11] }</span></td>
										<td class=input-td><input name="expert.Expert_Field12"
											type="text" class=input-text /></td>
										<td class="thirdTd">${remariksName[11] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[12] }</span></td>
										<td class=input-td><input name="expert.Expert_Field13"
											type="text" class=input-text /></td>
										<td class="thirdTd">${remariksName[12] }</td>
									</tr>
									<tr>

										<td class="firTd"><span class="STYLE7">${fieldName[13] }</span></td>
										<td class=input-td><input name="expert.Expert_Field14"
											type="text" class=input-text /></td>
										<td class="thirdTd">${remariksName[13] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[14] }</span></td>
										<td class=input-td><select name="expert.Expert_Field15"
											class=input-text>
												<option value="-1">-</option>
												<option value="1">选项一</option>
												<option value="2">选项二</option>
										</select>
										<td class="thirdTd">${remariksName[14] }</td>
									</tr>
									<tr>

										<td class="firTd"><span class="STYLE7">${fieldName[15] }</span></td>
										<td class=input-td><select name="expert.Expert_Field16"
											id="firstQuery" class=input-text>
												<option value="-1">-</option>
												<option value="1">选项一</option>
												<option value="2">选项二</option>
										</select></td>
										<td class="thirdTd">${remariksName[15] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[16] }</span></td>
										<td class=input-td><select name="expert.Expert_Field17"
											class=input-text>
												<option value="-1">-</option>
												<option value="1">选项一</option>
												<option value="2">选项二</option>
										</select></td>
										<td class="thirdTd">${remariksName[16] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[17] }</span></td>
										<td class=input-td><select name="expert.Expert_Field18"
											class=input-text>
												<option value="-1">-</option>
												<option value="1">选项一</option>
												<option value="2">选项二</option>
										</select></td>
										<td class="thirdTd">${remariksName[17] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[18] }</span></td>
										<td class=input-td><input name="expert.Expert_Field19"
											type="date" style="height:20px" /></td>
										<td class="thirdTd">${remariksName[18] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[19] }</span></td>
										<td class=input-td><select name="expert.Expert_Field20"
											class=input-text>
												<option value="-1">-</option>
												<option value="1">选项一</option>
												<option value="2">选项二</option>
										</select></td>
										<td class="thirdTd">${remariksName[19] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[20] }</span></td>
										<td class=input-td><select name="expert.Expert_Field21"
											class=input-text>
												<option value="-1">-</option>
												<option value="1">选项一</option>
												<option value="2">选项二</option>
										</select></td>
										<td class="thirdTd">${remariksName[20] }</td>
									</tr>
									<tr>

										<td class="firTd"><span class="STYLE7">${fieldName[21] }</span></td>
										<td class=input-td><select name="expert.Expert_Field22"
											class=input-text>
												<option value="-1">-</option>
												<option value="1">选项一</option>
												<option value="2">选项二</option>
										</select></td>
										<td class="thirdTd">${remariksName[21] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[22] }</span></td>
										<td class=input-td><select name="expert.Expert_Field23"
											class=input-text>
												<option value="-1">-</option>
												<option value="1">选项一</option>
												<option value="2">选项二</option>
										</select></td>
										<td class="thirdTd">${remariksName[22] }</td>
									</tr>
									<tr>

										<td class="firTd"><span class="STYLE7">${fieldName[23] }</span></td>
										<td class=input-td><input name="expert.Expert_Field24"
											type="date" style="height:20px" /></td>
										<td class="thirdTd">${remariksName[23] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[24] }</span></td>
										<td class=input-td><select name="expert.Expert_Field25"
											class=input-text>
												<option value="-1">-</option>
												<option value="1">选项一</option>
												<option value="2">选项二</option>
										</select></td>
										<td class="thirdTd">${remariksName[24] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[25] }</span></td>
										<td class=input-td><select name="expert.Expert_Field26"
											class=input-text>
												<option value="-1">-</option>
												<option value="1">选项一</option>
												<option value="2">选项二</option>
										</select></td>
										<td class="thirdTd">${remariksName[25] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[26] }</span></td>
										<td class=input-td><select name="expert.Expert_Field27"
											class=input-text>
												<option value="-1">-</option>
												<option value="1">选项一</option>
												<option value="2">选项二</option>
										</select></td>
										<td class="thirdTd">${remariksName[26] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[27] }</span></td>
										<td class=input-td><select name="expert.Expert_Field28"
											class=input-text>
												<option value="-1">-</option>
												<option value="1">选项一</option>
												<option value="2">选项二</option>
										</select></td>
										<td class="thirdTd">${remariksName[27] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[28] }</span></td>
										<td class=input-td><input name="expert.Expert_Field29"
											type="text" class=input-text /></td>
										<td class="thirdTd">${remariksName[28] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[29] }</span></td>
										<td class=input-td><input name="expert.Expert_Field30"
											type="text" class=input-text /></td>
										<td class="thirdTd">${remariksName[29] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[30] }</span></td>
										<td class=input-td><input name="expert.Expert_Field31"
											type="text" class=input-text /></td>
										<td class="thirdTd">${remariksName[30] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[31] }</span></td>
										<td class=input-td><input name="expert.Expert_Field32"
											type="text" class=input-text /></td>
										<td class="thirdTd">${remariksName[31] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[32] }</span></td>
										<td class=input-td><input name="expert.Expert_Field33"
											type="text" class=input-text /></td>
										<td class="thirdTd">${remariksName[32] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[33] }</span></td>
										<td class=input-td><input name="expert.Expert_Field34"
											type="text" class=input-text /></td>
										<td class="thirdTd">${remariksName[33] }</td>
									</tr>
									<tr>
										<td class="firTd"><span class="STYLE7">${fieldName[34] }</span></td>
										<td class=input-td><input name="expert.Expert_Field35"
											type="date" style="height:20px" /></td>
